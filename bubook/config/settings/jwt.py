...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "bubook.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "bubook.authentication.services.auth_jwt_response_payload_handler",
