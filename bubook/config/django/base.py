...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'bubook.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'bubook.api.exception_handlers.hacksoft_proposed_exception_handler',
